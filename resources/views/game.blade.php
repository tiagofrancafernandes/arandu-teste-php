...
<body>
    ...
    <div class="flex items-center justify-center" style="height: 100vh; flex-direction: column;">
        ...
        <table>
            <tbody>
                @for ($j = 0; $j < \App\Constants\Map::HEIGHT; $j++) <!-- row {{$j}} -->
                    <tr>
                        @for($i = 0; $i < \App\Constants\Map::WIDTH; $i++) <!-- column {{$i}} -->
                            <td style="width: {{\App\Constants\Map::TILE_SIZE}}px; height: {{\App\Constants\Map::TILE_SIZE}}px;"
                                class="tile-{{ $i }}-{{ $j }}">
